   ...
   struct DevBase *base)
{
   ...
   if((unit->flags&UNITF_ROADRUNNER)!=0)
      info->BPS=100000000;
...
/****** 3c589.device/S2_GETSTATIONADDDRESS *********************************
*
*   NAME
...
/****** 3c589.device/S2_CONFIGINTERFACE ************************************
*
*   NAME
*	S2_CONFIGINTERFACE --
*
...
/****** 3c589.device/S2_DELMULTICASTADDRESS ********************************
*
*   NAME
*	S2_DELMULTICASTADDRESS --
*
...
/****** 3c589.device/S2_DELMULTICASTADDRESSES ******************************
*
*   NAME
*	S2_DELMULTICASTADDRESSES --
*
